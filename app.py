...
def _get_preferred_language_value() -> str | None:
    ...
    if "portugu" in lang_lower or lang_lower in {"pt", "pt-br", "pt_br"}:
        return None
    return lang
...
def handle_user_query(query: str) -> None:
    ...
    st.session_state.messages.append({"role": "user", "content": raw_query, "timestamp": _now()})
